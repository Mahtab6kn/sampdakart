...
const page = () => {
  return (
    <div className="w-4/5 mx-auto my-10 p-6 bg-white shadow-lg rounded-lg flex flex-col gap-6">
      <h1 className="text-4xl font-semibold text-blue-500 border-b pb-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Sampdakart.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sampdakart, accessible from{" "}
            <a
              href="sampdakart.com"
      ...
      <ul>
        <li>
          <p>By email: sampdakart@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="sampdakart.com/contactUs"
              rel="external nofollow noopener"
              target="_blank"
            >
              sampdakart.com/contactUs
            </a>
          </p>
        </li>
      </ul>
