    ...
    <div className="rounded-lg flex flex-col gap-5 border-2 border-gray-500 w-full p-4">
      <Heading
        icon={
          <div className="inline-block pr-1">
            <LiaShippingFastSolid size={25} color="red" />
          </div>
        }
      ...
      <form>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input label="Fullname" value={formData.name} readOnly />
          <Input label="Phone Number" value={formData.phone} readOnly />
          <Input label="Email" value={formData.email} readOnly />
          <Input label="City" value={formData.city} readOnly />
          <Input label="State" value={formData.state} readOnly />
          <Input label="Pincode" value={formData.pincode} readOnly />
        </div>
